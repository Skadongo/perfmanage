...
import { formatDate, formatDateTimeLong } from '@/lib/dateUtils';
            ...
            <div className="space-y-6">
              ...
              {review.submitted_at && (
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  Submitted on {formatDateTimeLong(review.submitted_at)}
                </div>
              )}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-600 text-foreground">
                        {formatDate(review.supervisor_reviewed_at)}
                      </p>
                    </div>
              ...
              {review.review_status === 'approved' && review.approval_comments && (
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
                  <p className="text-xs font-700 text-emerald-700 mb-1 flex items-center gap-1.5">
                    ...
                    Approved — {review.approved_at ? formatDate(review.approved_at) : ''}
                  </p>
